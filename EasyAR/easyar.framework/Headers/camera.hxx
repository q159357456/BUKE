...
public:
    ...
    bool start();
    bool stop();
    AndroidCameraApiType getAndroidCameraApiType();
...
{
protected:
    easyar_CameraDeviceSelector * cdata_ ;
    void init_cdata(easyar_CameraDeviceSelector * cdata);
    virtual CameraDeviceSelector & operator=(const CameraDeviceSelector & data) { return *this; } //deleted
public:
    CameraDeviceSelector(easyar_CameraDeviceSelector * cdata);
    virtual ~CameraDeviceSelector();

    CameraDeviceSelector(const CameraDeviceSelector & data);
    const easyar_CameraDeviceSelector * get_cdata() const;
    easyar_CameraDeviceSelector * get_cdata();

    void createCameraDevice(CameraDevicePreference preference, /* OUT */ CameraDevice * * Return);
    static void deviceModelName(/* OUT */ String * * Return);
};
...
inline AndroidCameraApiType CameraDevice::getAndroidCameraApiType()
{
    if (cdata_ == NULL) {
        return AndroidCameraApiType();
    }
    easyar_AndroidCameraApiType _return_value_ = easyar_CameraDevice_getAndroidCameraApiType(cdata_);
...
inline CameraDeviceSelector::CameraDeviceSelector(easyar_CameraDeviceSelector * cdata)
    :
    cdata_(NULL)
{
    init_cdata(cdata);
}
inline CameraDeviceSelector::~CameraDeviceSelector()
{
    if (cdata_) {
        easyar_CameraDeviceSelector__dtor(cdata_);
        cdata_ = NULL;
    }
}

inline CameraDeviceSelector::CameraDeviceSelector(const CameraDeviceSelector & data)
    :
    cdata_(NULL)
{
    easyar_CameraDeviceSelector * cdata = NULL;
    easyar_CameraDeviceSelector__retain(data.cdata_, &cdata);
    init_cdata(cdata);
}
inline const easyar_CameraDeviceSelector * CameraDeviceSelector::get_cdata() const
{
    return cdata_;
}
inline easyar_CameraDeviceSelector * CameraDeviceSelector::get_cdata()
{
    return cdata_;
}
inline void CameraDeviceSelector::init_cdata(easyar_CameraDeviceSelector * cdata)
{
    cdata_ = cdata;
}
inline void CameraDeviceSelector::createCameraDevice(CameraDevicePreference arg0, /* OUT */ CameraDevice * * Return)
{
    ...
    easyar_CameraDevice * _return_value_ = NULL;
    easyar_CameraDeviceSelector_createCameraDevice(cdata_, static_cast<easyar_CameraDevicePreference>(arg0), &_return_value_);
    *Return = (_return_value_ == NULL ? NULL : new CameraDevice(_return_value_));
}
inline void CameraDeviceSelector::deviceModelName(/* OUT */ String * * Return)
{
    easyar_String * _return_value_ = NULL;
    easyar_CameraDeviceSelector_deviceModelName(&_return_value_);
