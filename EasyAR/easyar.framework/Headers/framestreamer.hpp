...
inline void FrameStreamer::setMirrorCamera()
{
    easyar_FrameStreamer_setMirrorCamera(cdata_.get());
}
...
inline void CameraFrameStreamer::setMirrorCamera()
{
    easyar_CameraFrameStreamer_setMirrorCamera(cdata_.get());
}
...
inline void ExternalFrameStreamer::setMirrorCamera()
{
    easyar_ExternalFrameStreamer_setMirrorCamera(cdata_.get());
}
