...
public:
    ...
    static void createWithMode(ImageTrackerMode trackMode, ImageSourceMode sourceMode, /* OUT */ ImageTracker * * Return);
...
inline void ImageTracker::createWithMode(ImageTrackerMode arg0, ImageSourceMode arg1, /* OUT */ ImageTracker * * Return)
{
    easyar_ImageTracker * _return_value_ = NULL;
    easyar_ImageTracker_createWithMode(static_cast<easyar_ImageTrackerMode>(arg0), static_cast<easyar_ImageSourceMode>(arg1), &_return_value_);
