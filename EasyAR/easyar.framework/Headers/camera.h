...
easyar_AndroidCameraApiType easyar_CameraDevice_getAndroidCameraApiType(easyar_CameraDevice * This);
...
void easyar_CameraDeviceSelector_createCameraDevice(easyar_CameraDeviceSelector * This, easyar_CameraDevicePreference preference, /* OUT */ easyar_CameraDevice * * Return);
void easyar_CameraDeviceSelector_deviceModelName(/* OUT */ easyar_String * * Return);
void easyar_CameraDeviceSelector__dtor(easyar_CameraDeviceSelector * This);
void easyar_CameraDeviceSelector__retain(const easyar_CameraDeviceSelector * This, /* OUT */ easyar_CameraDeviceSelector * * Return);
const char * easyar_CameraDeviceSelector__typeName(const easyar_CameraDeviceSelector * This);
