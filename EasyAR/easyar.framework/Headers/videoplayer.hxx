...
public:
    ...
    void open(String * path, StorageType storageType, CallbackScheduler * callbackScheduler, FunctorOfVoidFromVideoStatus callback);
    void close();
    bool play();
    bool stop();
    bool pause();
...
inline void VideoPlayer::setRenderTexture(TextureId * arg0)
{
    ...
    easyar_VideoPlayer_setRenderTexture(cdata_, (arg0 == NULL ? NULL : arg0->get_cdata()));
}
inline void VideoPlayer::open(String * arg0, StorageType arg1, CallbackScheduler * arg2, FunctorOfVoidFromVideoStatus arg3)
{
    if (cdata_ == NULL) {
        return;
    }
    easyar_VideoPlayer_open(cdata_, arg0->get_cdata(), static_cast<easyar_StorageType>(arg1), (arg2 == NULL ? NULL : arg2->get_cdata()), FunctorOfVoidFromVideoStatus_to_c(arg3));
}
