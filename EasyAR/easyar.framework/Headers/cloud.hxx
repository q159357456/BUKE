...
public:
    ...
    void open(String * server, String * appKey, String * appSecret, CallbackScheduler * callbackScheduler, FunctorOfVoidFromCloudStatusAndListOfPointerOfTarget callback);
    bool close();
...
inline void CloudRecognizer::setMirrorCamera()
{
    ...
    easyar_CloudRecognizer_setMirrorCamera(cdata_);
}
inline void CloudRecognizer::open(String * arg0, String * arg1, String * arg2, CallbackScheduler * arg3, FunctorOfVoidFromCloudStatusAndListOfPointerOfTarget arg4)
{
    if (cdata_ == NULL) {
        return;
    }
    easyar_CloudRecognizer_open(cdata_, arg0->get_cdata(), arg1->get_cdata(), arg2->get_cdata(), (arg3 == NULL ? NULL : arg3->get_cdata()), FunctorOfVoidFromCloudStatusAndListOfPointerOfTarget_to_c(arg4));
}
