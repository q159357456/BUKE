...
{
protected:
    std::shared_ptr<easyar_CameraDeviceSelector> cdata_;
    void init_cdata(std::shared_ptr<easyar_CameraDeviceSelector> cdata);
    CameraDeviceSelector & operator=(const CameraDeviceSelector & data) = delete;
public:
    CameraDeviceSelector(std::shared_ptr<easyar_CameraDeviceSelector> cdata);
    virtual ~CameraDeviceSelector();

    std::shared_ptr<easyar_CameraDeviceSelector> get_cdata();

    std::shared_ptr<CameraDevice> createCameraDevice(CameraDevicePreference preference);
...
{
    auto _return_value_ = easyar_CameraDevice_getAndroidCameraApiType(cdata_.get());
...
inline CameraDeviceSelector::CameraDeviceSelector(std::shared_ptr<easyar_CameraDeviceSelector> cdata)
    :
    cdata_(nullptr)
{
    init_cdata(cdata);
...
inline std::shared_ptr<easyar_CameraDeviceSelector> CameraDeviceSelector::get_cdata()
{
    return cdata_;
}
inline void CameraDeviceSelector::init_cdata(std::shared_ptr<easyar_CameraDeviceSelector> cdata)
{
    cdata_ = cdata;
}
inline std::shared_ptr<CameraDevice> CameraDeviceSelector::createCameraDevice(CameraDevicePreference arg0)
{
    easyar_CameraDevice * _return_value_;
    easyar_CameraDeviceSelector_createCameraDevice(cdata_.get(), static_cast<easyar_CameraDevicePreference>(arg0), &_return_value_);
    return (_return_value_ == nullptr ? nullptr : std::make_shared<CameraDevice>(std::shared_ptr<easyar_CameraDevice>(_return_value_, [](easyar_CameraDevice * ptr) { easyar_CameraDevice__dtor(ptr); })));
}
inline std::string CameraDeviceSelector::deviceModelName()
{
