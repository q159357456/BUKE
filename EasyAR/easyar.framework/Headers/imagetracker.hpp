...
public:
    ...
    static std::shared_ptr<ImageTracker> createWithMode(ImageTrackerMode trackMode, ImageSourceMode sourceMode);
...
inline std::shared_ptr<ImageTracker> ImageTracker::createWithMode(ImageTrackerMode arg0, ImageSourceMode arg1)
{
    easyar_ImageTracker * _return_value_;
