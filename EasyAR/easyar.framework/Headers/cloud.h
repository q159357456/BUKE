...
void easyar_CloudRecognizer_setMirrorCamera(easyar_CloudRecognizer * This);
void easyar_CloudRecognizer_open(easyar_CloudRecognizer * This, easyar_String * server, easyar_String * appKey, easyar_String * appSecret, easyar_CallbackScheduler * callbackScheduler, easyar_FunctorOfVoidFromCloudStatusAndListOfPointerOfTarget callback);
