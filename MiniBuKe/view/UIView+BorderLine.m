...
- (UIView *)borderForColor:(UIColor *)color borderWidth:(CGFloat)borderWidth borderType:(UIBorderSideType)borderType {
    ...
    borderWidth = scale > 0.0 ? borderWidth/ scale : borderWidth;
...
-(void)addBottomLine:(UIColor *)color borderWidth:(CGFloat)width{
    ...
    layer.bounds = CGRectMake(self.bounds.origin.x, self.bounds.origin.y, self.bounds.size.width, self.bounds.size.width-width);
