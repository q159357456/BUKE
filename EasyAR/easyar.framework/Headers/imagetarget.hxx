...
public:
    ...
    static void createFromTargetFile(String * fullname, /* OUT */ ImageTarget * * Return);
...
inline void ImageTargetParameters::setImage(Image * arg0)
{
    ...
    easyar_ImageTargetParameters_setImage(cdata_, (arg0 == NULL ? NULL : arg0->get_cdata()));
}
...
{
    easyar_ImageTarget * _return_value_ = NULL;
    easyar_ImageTarget_createFromParameters((arg0 == NULL ? NULL : arg0->get_cdata()), &_return_value_);
    *Return = (_return_value_ == NULL ? NULL : new ImageTarget(_return_value_));
}
inline void ImageTarget::createFromTargetFile(String * arg0, /* OUT */ ImageTarget * * Return)
{
    easyar_ImageTarget * _return_value_ = NULL;
    easyar_ImageTarget_createFromTargetFile(arg0->get_cdata(), &_return_value_);
    *Return = (_return_value_ == NULL ? NULL : new ImageTarget(_return_value_));
}
