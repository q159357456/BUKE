...
static void FunctorOfVoidFromPointerOfTargetAndBool_func(void * _state, easyar_Target *, bool, /* OUT */ easyar_String * * _exception);
...
inline TargetTrackerResult::TargetTrackerResult(std::shared_ptr<easyar_TargetTrackerResult> cdata)
    :
    cdata_(nullptr)
{
    init_cdata(cdata);
...
inline std::shared_ptr<easyar_TargetTrackerResult> TargetTrackerResult::get_cdata()
{
    return cdata_;
}
inline void TargetTrackerResult::init_cdata(std::shared_ptr<easyar_TargetTrackerResult> cdata)
{
    cdata_ = cdata;
}
inline std::vector<std::shared_ptr<TargetInstance>> TargetTrackerResult::targetInstances()
{
...
inline void TargetTracker::loadTarget(std::shared_ptr<Target> arg0, std::shared_ptr<CallbackScheduler> arg1, std::function<void(std::shared_ptr<Target>, bool)> arg2)
{
    easyar_TargetTracker_loadTarget(cdata_.get(), (arg0 == nullptr ? nullptr : arg0->get_cdata().get()), (arg1 == nullptr ? nullptr : arg1->get_cdata().get()), FunctorOfVoidFromPointerOfTargetAndBool_to_c(arg2));
}
inline void TargetTracker::unloadTarget(std::shared_ptr<Target> arg0, std::shared_ptr<CallbackScheduler> arg1, std::function<void(std::shared_ptr<Target>, bool)> arg2)
{
    easyar_TargetTracker_unloadTarget(cdata_.get(), (arg0 == nullptr ? nullptr : arg0->get_cdata().get()), (arg1 == nullptr ? nullptr : arg1->get_cdata().get()), FunctorOfVoidFromPointerOfTargetAndBool_to_c(arg2));
}
...
static void FunctorOfVoidFromPointerOfTargetAndBool_func(void * _state, easyar_Target * arg0, bool arg1, /* OUT */ easyar_String * * _exception)
{
    *_exception = nullptr;
    try {
