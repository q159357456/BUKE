...
typedef enum
{
    ...
    easyar_CameraDevicePreference_PreferWorldSensing = 1,
...
typedef enum
{
    easyar_ImageSourceMode_Normal = 0,
    easyar_ImageSourceMode_Mirror = 1,
} easyar_ImageSourceMode;
...
{
    void * _state;
    void (* func)(void * _state, easyar_CloudStatus, easyar_ListOfPointerOfTarget *, /* OUT */ easyar_String * * _exception);
    void (* destroy)(void * _state);
