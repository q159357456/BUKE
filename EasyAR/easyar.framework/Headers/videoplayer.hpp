...
#ifndef __EASYAR_VIDEOPLAYER_HPP__
#define __EASYAR_VIDEOPLAYER_HPP__
...
public:
    ...
    void open(std::string path, StorageType storageType, std::shared_ptr<CallbackScheduler> callbackScheduler, std::function<void(VideoStatus)> callback);
    void close();
    bool play();
    bool stop();
    bool pause();
...
#ifndef __IMPLEMENTATION_EASYAR_VIDEOPLAYER_HPP__
#define __IMPLEMENTATION_EASYAR_VIDEOPLAYER_HPP__
...
inline void VideoPlayer::setRenderTexture(std::shared_ptr<TextureId> arg0)
{
    easyar_VideoPlayer_setRenderTexture(cdata_.get(), (arg0 == nullptr ? nullptr : arg0->get_cdata().get()));
}
inline void VideoPlayer::open(std::string arg0, StorageType arg1, std::shared_ptr<CallbackScheduler> arg2, std::function<void(VideoStatus)> arg3)
{
    easyar_VideoPlayer_open(cdata_.get(), std_string_to_easyar_String(arg0).get(), static_cast<easyar_StorageType>(arg1), (arg2 == nullptr ? nullptr : arg2->get_cdata().get()), FunctorOfVoidFromVideoStatus_to_c(arg3));
}
